...
if __name__ == "__main__" :
    ...
    ISIC_2019_path = f"{args.data_path}/ISIC_2019"
    ...
    HAM_10000_path = f"{args.data_path}/HAM10000"
    ...
    # Client : Barcelona
    ############################################################################################################################
    ISIC_2019_data_path = f"{args.data_path}/ISIC_2019"
    ...
    file_path = os.path.join( f"{args.data_path}/ISIC_2019", "ISIC_19_Barcelona.json")
    ...
    HAM_10000_data_path = f"{args.data_path}/HAM10000"
    ...
    file_path = os.path.join( f"{args.data_path}/HAM10000", "HAM_rosendahl.json")
    ...
    file_path = os.path.join( f"{args.data_path}/HAM10000", "HAM_vienna.json")
    ...
    PAD_UFES_20_data_path = f"{args.data_path}/PAD-UFES-20"
    ...
    # Client : SF_canada
    ############################################################################################################################
    Derm7pt_data_path = f"{args.data_path}/Derm7pt/images"
